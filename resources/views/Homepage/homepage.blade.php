    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            <ul class="navbar-nav d-flex justify-content-between">
                ...
                <div class="d-flex flex-lg-row flex-column">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{url('Homepage/homepage')}}">Home <span class="sr-only">(current)</span></a>
                    </li>
            ...
            <ul class="navbar-nav d-flex justify-content-between">
                <div class="d-flex flex-lg-row flex-column">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{url('Homepage/menu')}}">Register</a>
                    </li>
                    <li class="nav-item">
	...
	<div class="row d-flex align-items-center">
		<div class="col-lg-6 hero-left">
		    ...
		    <div class="mb-2">
			    ...
			    <a class="btn btn-icon btn-lg" href="https://www.youtube-nocookie.com/embed/LwNZTfjZTPc" data-featherlight="iframe" data-featherlight-iframe-allowfullscreen="true">
